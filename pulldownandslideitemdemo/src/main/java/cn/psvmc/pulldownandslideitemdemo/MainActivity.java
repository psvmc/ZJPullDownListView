package cn.psvmc.pulldownandslideitemdemo;
...
import cn.psvmc.zjslideitem.SlideView;
        ...
        mAdapter = new BaseAdapter() {
            ...
            public View getView(int position, View convertView, ViewGroup parent) {
                ...
                if (slideView == null) {
                    ...
                    slideView = new SlideView(MainActivity.this, R.layout.slide_view_merge, R.id.view_content);
